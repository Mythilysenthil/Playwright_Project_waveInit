...
When(
  "the user clicks Training Programs in the Admin Panel",
...
When(
  "the user clicks the Add Training button",
  async function (this: CustomWorld) {
...
When(
  "the user enters the training description",
  async function (this: CustomWorld) {
    await this.tp.setDescription(
      "Training program for Playwright automation with TypeScript",
    );
  },
);

When(
  "the user enters and selects the trainer name",
  async function (this: CustomWorld) {
...
When(
  "the user clicks the Create Training Session button",
  async function (this: CustomWorld) {
...
Then(
  "the user should see the training session created successfully",
  async function (this: CustomWorld) {
...
When(
  "the user enters the training title {string}",
...
When(
  "the user sets the start date {string} and end date {string}",
...
Then(
  "the user should see the validation message {string}",
